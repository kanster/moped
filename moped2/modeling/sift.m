% SIFT - This function reads an image and returns its SIFT keypoints.
%
...
sift_path = fileparts(mfilename('fullpath'));
...
if isunix
    command = ['!' fullfile(sift_path, 'sift ')];
else
    command = ['!' fullfile(sift_path, 'siftWin32 ')];
end
