...
# extract_focal.pl [image_list] [output_dir]
...
if ($IMAGE_LIST eq "") {
	...
	# ALVARO: I don't want no stinkin' IMAGE_DIR
...
#    }
    ...
    $line = sprintf("%s.jpg 0 0", $basename); # ALVARO'S HACK TO ARTIFICIALLY OBTAIN INITIAL FOCAL DISTANCES
    }
